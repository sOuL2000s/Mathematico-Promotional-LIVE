...
const AboutPage = () => {
  return (
    <div className="container mx-auto py-8 md:py-12 px-4 min-h-screen">
      <h1 className="text-4xl sm:text-5xl font-bold text-dark mb-6 md:mb-8 text-center">About Mathematico</h1>

      <section className="bg-white p-6 md:p-8 rounded-lg shadow-md mb-6 md:mb-8 border border-gray-100">
        <h2 className="text-2xl sm:text-3xl font-semibold text-primary mb-3 md:mb-4">Our Mission</h2>
      ...
      <section className="bg-white p-6 md:p-8 rounded-lg shadow-md mb-6 md:mb-8 border border-gray-100">
        <h2 className="text-2xl sm:text-3xl font-semibold text-primary mb-3 md:mb-4">Our Vision</h2>
        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
      ...
      <section className="bg-white p-6 md:p-8 rounded-lg shadow-md mb-6 md:mb-8 border border-gray-100">
        <h2 className="text-2xl sm:text-3xl font-semibold text-primary mb-3 md:mb-4">Our Values</h2>
        <ul className="list-disc list-inside text-base sm:text-lg text-gray-700 space-y-2 md:space-y-3">
          <li>
      ...
      <section className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-gray-100">
        <h2 className="text-2xl sm:text-3xl font-semibold text-primary mb-3 md:mb-4">Our Story</h2>
        <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-3 md:mb-4">
