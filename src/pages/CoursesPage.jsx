    ...
    <div className="container mx-auto py-8 md:py-12 px-4 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {courses.map((course, index) => (
          <div key={index} className="bg-medium-dark rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-secondary flex flex-col animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
            ...
            <div className="p-4 sm:p-6 flex flex-col flex-grow">
              <div className="flex items-center mb-2 sm:mb-3">
                {course.icon && <course.icon className="text-accent text-2xl mr-2" />}
              ...
              <button className="mt-4 sm:mt-6 bg-accent text-dark-background font-bold py-2.5 px-5 sm:px-6 rounded-lg hover:bg-cyan-400 transition-all duration-300 transform hover:scale-105 shadow-md self-start text-sm sm:text-base">
                Enroll Now
              </button>
            </div>
          </div>
